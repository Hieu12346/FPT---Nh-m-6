...
//////////////////////////////////////////////////////////////////
const priceData = {
  "256GB": { newPrice: 10990000, oldPrice: 12990000 },
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addToCart = function () {
    ...
    let imageMap = {
      Tím: "../Ảnh/oppo_reno13_f_5g_tim_5_858ba5c2ad (1).png",
      Xám: "../Ảnh/oppo_reno13_f_5g_xam_4_40988633f5.png",
    };
...
const defaultRatings = [0, 1, 0, 0, 0];
const totalRatingsDefault = 1;
const totalScoreDefault = 0 * 5 + 1 * 4 + 0 * 3 + 0 * 2 + 0 * 1;
