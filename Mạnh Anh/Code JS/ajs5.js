...
//////////////////////////////////////////////////////////////////
const priceData = {
  "512GB": { newPrice: 14990000, oldPrice: 17990000 },
  "1TB": { newPrice: 15490000, oldPrice: 18990000 },
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.addToCart = function () {
    ...
    let imageMap = {
      Xám: "../Ảnh/xiaomi_14t_pro_titan_gray_1_45b1866e10 (1).png",
      Đen: "../Ảnh/xiaomi_14t_pro_black_1_6d563df835.png",
      "Xanh Dương": "../Ảnh/xiaomi_14t_pro_blue_1_5f61c0cb50.png",
    };
...
const defaultRatings = [10, 0, 1, 0, 1];
const totalRatingsDefault = 12;
const totalScoreDefault = 10 * 5 + 0 * 4 + 1 * 3 + 0 * 2 + 1 * 1;
