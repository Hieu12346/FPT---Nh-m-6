...
const defaultRatings = [3, 1, 0, 0, 0];
const totalRatingsDefault = 4; // Tổng số lượt đánh giá mặc định
const totalScoreDefault = 3 * 5 + 1 * 4 + 0 * 3 + 0 * 2 + 0 * 1;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  addToCartButton.addEventListener("click", function () {
    const product = {
      name: "Máy sưởi gốm Kangaroo KGFH08",
      price: 3490000, // Giá hiện tại
      oldPrice: 4890000, // Giá cũ
      image: "../../Mạnh Anh/Ảnh/0.jpg", // Đường dẫn hình ảnh sản phẩm
      quantity: 1, // Số lượng mặc định
      storage: "15-25 m2", // Dung tích
      color: "Đen", // Màu sắc
    };
