...
document.addEventListener("DOMContentLoaded", function () {
  ...
  addToCartButton.addEventListener("click", function () {
    const product = {
      name: "Robot hút bụi lau nhà Dreame X50 Ultra",
      price: 29990000, // Giá hiện tại
      oldPrice: 30990000, // Giá cũ
      image: "../../Mạnh Anh/Ảnh/331.png", // Đường dẫn hình ảnh sản phẩm
      quantity: 1, // Số lượng mặc định
      storage: "6400 mAh", // Dung tích
      color: "Đen", // Màu sắc
    };
