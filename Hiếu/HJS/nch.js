...
const defaultRatings = [2, 1, 0, 0, 0];
const totalRatingsDefault = 3; // Tổng số lượt đánh giá mặc định
const totalScoreDefault = 2 * 5 + 1 * 4 + 0 * 3 + 0 * 2 + 0 * 1;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  addToCartButton.addEventListener("click", function () {
    const product = {
      name: "Nồi chiên không dầu điện tử Kangaroo 15L KG15AF3A",
      price: 3190000, // Giá hiện tại
      oldPrice: 6790000, // Giá cũ
      image: "../../Mạnh Anh/Ảnh/11.jpg", // Đường dẫn hình ảnh sản phẩm
      quantity: 1, // Số lượng mặc định
      storage: "15 lít", // Dung tích
      color: "Bạc", // Màu sắc
    };
